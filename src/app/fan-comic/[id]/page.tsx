/**
 * @fileoverview Página de detalles para un fan comic específico.
 * 
 * Página de servidor para mostrar los detalles de un fan comic.
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  const mediaData = getMediaPageData(params.id, 'fan-comic');
