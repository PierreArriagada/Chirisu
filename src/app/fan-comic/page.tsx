/**
 * @fileoverview Página de la categoría "Fan Comic".
 * 
 * Hub principal para todo el contenido de fan comics. Sigue la misma
...
const popularGenres = ["Acción", "Superhéroes", "Aventura", "Comedia", "Drama", "Fantasía"];

export default function FanComicPage() {
    const mediaType: MediaType = "Fan Comic";
