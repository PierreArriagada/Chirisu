/**
 * @fileoverview Página de la categoría "Manwha".
 * 
 * Hub principal para todo el contenido de manwha (cómics coreanos). Sigue la misma
...
export default function ManwhaPage() {
    const mediaType: MediaType = "Manwha";
