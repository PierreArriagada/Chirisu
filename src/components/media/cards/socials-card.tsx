 ...
 * problemas de contenido, que activa el `ReportProblemDialog`. Cada botón ahora
 * incluye una etiqueta de texto para mayor claridad.
 */
'use client';
import { Card, CardContent } from "@/components/ui/card";
import { Facebook, Flag } from "lucide-react";
import { useState } from "react";
import { ReportProblemDialog } from "@/components/shared";
