...
// import { getMediaPageData } from '@/lib/data'; // Componente obsoleto
import { MediaType } from '@/lib/types';

type MediaPageProps = {
  mediaData: any; // NonNullable<ReturnType<typeof getMediaPageData>>
}

// Mapeo de tipos de media para la API de comentarios
const mapMediaTypeToAPI = (type: MediaType): string => {
  const mapping: Record<MediaType, string> = {
    'Anime': 'anime',
    'Manga': 'manga',
    'Novela': 'novel',
    'Donghua': 'donghua',
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-8">
        <div className="lg:col-span-2 flex flex-col gap-8">
            ...
            {reviews && reviews.length > 0 && (
              <Card>
                <AccordionItem value="reviews" className="border-0">
                  ...
                  <AccordionContent>
                    <ReviewsSection 
                      mediaId={titleInfo.id.toString()} 
                      mediaType={mapMediaTypeToAPI(titleInfo.type) as any} 
          ...
          <div className="lg:hidden">
            ...
            <Recommendations 
              currentMediaId={titleInfo.id.toString()}
              currentMediaType={mapMediaTypeToAPI(titleInfo.type)}
          ...
          <CommentsSection 
            commentableType={mapMediaTypeToAPI(titleInfo.type) as any}
            commentableId={titleInfo.id}
          />
