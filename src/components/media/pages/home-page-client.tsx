...
import { TopRankingCarousel } from '@/components/rankings';
import { Loader2 } from 'lucide-react';

// Tipos de media soportados en la aplicación
const mediaTypes: MediaType[] = ['Anime', 'Manga', 'Novela', 'Donghua', 'Manhua', 'Manhwa', 'Fan Comic'];

// ============================================
// Mapeo de MediaType a parámetro de API
// ============================================
// La API acepta: 'anime', 'manga', 'novel', 'donghua', 'manhua', 'manhwa', 'fan_comic'
    ...
    const loadAllRankings = async () => {
      try {
        ...
        console.log('📊 Rankings summary:', {
          ...
          Donghua: newRankings['Donghua']?.length || 0,
          Manhua: newRankings['Manhua']?.length || 0,
          Manhwa: newRankings['Manhwa']?.length || 0,
          'Fan Comic': newRankings['Fan Comic']?.length || 0,
        });
