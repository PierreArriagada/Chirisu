...
interface ContributionFormProps {
    mediaType: "Anime" | "Donghua" | "Manga" | "Novela" | "Fan Comic" | "Manhua" | "Manhwa";
}
...
export default function ContributionForm({ mediaType }: ContributionFormProps) {
    ...
    const isAnimated = mediaType === 'Anime' || mediaType === 'Donghua';
    ...
    async function onSubmit(data: FormData) {
        try {
            // Convertir el mediaType al formato correcto para la base de datos
            const mediaTypeMap: Record<string, string> = {
                ...
                'Manhua': 'manhua',
                'Manhwa': 'manhwa',
                'Fan Comics': 'fan_comic',
            };

            const dbMediaType = mediaTypeMap[mediaType] || mediaType.toLowerCase();

            const response = await fetch('/api/contributions/submit-media', {
                method: 'POST',
                headers: {
